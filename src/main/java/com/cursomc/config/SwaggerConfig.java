...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)					
					.useDefaultResponseMessages(false) //desabilita a resposta padrão
					...
					.select()
					.apis(RequestHandlerSelectors.basePackage("com.cursomc.resources")) //nome do pacote que vai gerar a documentação
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do projeto Spring Boot",
			"Esta API é utilizada no projeto Spring Boot REST com JPA",
			"Versão 1.0",
			"Link do termo de uso",
			new Contact("Luis Paulo", "site do proprietário", "meuEmail@gmail.com"),
			"Permitido uso para consulta",
			"Link do termo de uso",
